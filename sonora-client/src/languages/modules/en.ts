export default {
  ...
  search: {
    ...
    hint: 'Search songs, artists, albums, and playlists',
    title: 'Discover Music',
    recentSearches: 'Recent Searches',
    hotSearches: 'Hot Searches',
    foundResults: 'Found {count} results',
    showingCount: 'Showing {count} / {total}',
    searchingHint: 'Song, artist, album, and playlist results are shown here',
    sections: {
      songs: 'Songs',
      artists: 'Artists',
      albums: 'Albums',
  ...
  playlist: {
    ...
    messages: {
      ...
      invalidCover: 'Please choose an image file',
      coverTooLarge: 'Playlist cover must be 5MB or smaller',
    ...
    edit: {
      ...
      resetCover: 'Use Auto Cover',
      coverHint: 'Cover URLs are no longer used. Without a custom cover, the first song cover is used, or the default cover when the playlist is empty.',
      coverAutoPending: 'Save to switch back to the automatic cover',
